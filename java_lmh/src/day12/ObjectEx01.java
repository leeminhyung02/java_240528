...
public class ObjectEx01 {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println("std1 == std5 : "+ (std1 == std5));  //std1과 std5는 다른객체
		System.out.println("std1.equals(std5) : " + std1.equals(std5));  //값은 같음
	}
...
class Student implements Cloneable{
	...
	public boolean equals(Object obj) {
		...
		if (this == obj)
			return true;
		//비교대상이 null인 경우 =>비교할 수가 없음
		if (obj == null)
			return false;
		//내클래스와 매개변수의 클래스가 다른경우
