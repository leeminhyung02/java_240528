...
public class ListSortEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * 	그런데 아래 코드에서 String 클래스는 라이브러리에서 제공하는 클래스이기 때문에 우리가 수정할 수 업삳.
		 * 	그래서 익명 클래스(이름이 없는 1회용 클래스)를 만들어서 해당 클래스의 객체를 이용
		 * 	-Comparator 인터페이스이 compare 추상 메소드를 오버라이딩해야하고 오버라이딩한 코드에 따라 정렬 방식이 바뀜
		 */
		...
		stds.add(new Student("2024160000","둘리	"));
