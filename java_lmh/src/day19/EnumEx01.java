...
public class EnumEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 열거형 정의(기본) enum 열거형명{ 값1. 값2, .... } 열거형 사용 열거형명 객체명 = 열거형.값;
		 * 
		 * 열거형.valueOf(문자열) : 입력한 문자열과 같은 열거형 값이 있으면 해당 객체로 리턴하고 없으면 예외 발생
		 */
		System.out.println("계절을 입력하세요(봄:SPRING, 여름:SUMMER, 가을:FALL 겨울:WINTER) :  ");
		...
		System.out.println("계절을 입력하세요(봄:1, 여름:2, 가을:3, 겨울:4) : ");
